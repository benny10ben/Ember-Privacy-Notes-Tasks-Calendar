...
class NoteEditorViewModel(
    ...
    init {
        viewModelScope.launch {
            com.ben.ember.domain.util.SyncEventBus.events.collect { event ->
                if (event !is com.ben.ember.domain.util.NoteSyncEvent.NoteChanged) return@collect
    ...
    fun loadNote(noteId: String) {
        ...
        com.ben.ember.domain.util.AiEventBus.activeNoteId = noteId
    ...
    fun generatePlainTextExport(): String {
        ...
        val body = com.ben.ember.domain.util.ExportEngine.generatePlainText(_blocks.value)
        return "$title\n\n$body"
    }

    fun generateMarkdownExport(): String {
        val title = _noteTitle.value.ifBlank { "Untitled Note" }
        val body = com.ben.ember.domain.util.ExportEngine.generateMarkdown(_blocks.value)
        return "# $title\n\n$body"
    }
}
