...
import com.ben.ember.domain.selfhost.sync.ApiConfigSyncEntry
import com.ben.ember.domain.selfhost.translation.EmbeddedBlockPayload
import com.ben.ember.domain.util.ChatSyncEventBus
...
class SyncRepositoryImpl(
    ...
    override suspend fun applyRemoteChanges(changes: List<SyncEnvelope>): Boolean =
        withContext(Dispatchers.IO) {
            ...
            com.ben.ember.domain.media.LocalMediaGcTrigger.requestCleanup()
