...
import com.ben.ember.domain.ai.external.ExternalAiEngine
...
class RagRepository(
    ...
    private companion object {
        val DEFAULT_SYSTEM_PROMPT = """
            You are Ember's AI assistant embedded in a note-taking app, answering questions using the user's notes plus your own general knowledge.
        ...
        val NOTES_ONLY_SYSTEM_PROMPT = """
            You are Ember's offline AI assistant embedded in a note-taking app.
        ...
        val WORLD_ONLY_SYSTEM_PROMPT = """
            You are Ember's AI assistant, acting as a general-purpose conversational assistant.
