...
class SyncClient(
    ...
    suspend fun listRemoteMedia(): List<com.ben.ember.domain.sync.RemoteMediaEntry> {
        return try {
            client.get("$serverUrl/sync/media/list").body<com.ben.ember.domain.sync.RemoteMediaList>().entries
        } catch (e: Exception) {
