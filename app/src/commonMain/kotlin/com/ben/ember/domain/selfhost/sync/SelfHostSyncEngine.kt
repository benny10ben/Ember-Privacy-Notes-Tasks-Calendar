...
import com.ben.ember.data.local.room.ChatSessionDao
import com.ben.ember.data.local.room.ChatSessionEntity
...
import com.ben.ember.data.local.room.SelfHostDeletedApiConfigDao
...
import com.ben.ember.domain.selfhost.media.MediaReferenceScanner
import com.ben.ember.domain.selfhost.merge.NoteMergeHelper
import com.ben.ember.domain.selfhost.translation.EmbeddedBlockPayload
import com.ben.ember.domain.selfhost.translation.NoteJsonCompiler
import com.ben.ember.domain.selfhost.translation.NoteJsonParser
import com.ben.ember.domain.selfhost.webdav.WebDavConfigurationException
import com.ben.ember.domain.selfhost.webdav.WebDavConflictException
import com.ben.ember.domain.selfhost.webdav.WebDavSyncClient
import com.ben.ember.domain.selfhost.webdav.WebDavSyncPaths
import com.ben.ember.domain.sync.MediaTransferPhase
import com.ben.ember.domain.sync.MediaTransferStatusBus
import com.ben.ember.domain.util.MediaStorageHelper
import com.ben.ember.domain.util.withSyncCoordinatorOrSkip
...
class SelfHostSyncEngine(
    ...
    private suspend fun reconcileChatSession(
        ...
        com.ben.ember.domain.util.ChatSyncEventBus.emitSessionChanged(sessionId)
        return remoteEntry
    }
    ...
    private suspend fun reconcileNote(candidateId: String, remoteEntry: SelfHostManifestEntry?): ReconcileOutcome {
        ...
        return try {
            ...
            com.ben.ember.domain.util.SyncEventBus.emitSyncCompleted(
