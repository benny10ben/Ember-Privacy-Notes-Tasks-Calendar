    ...
    Column(
        ...
        if (rows.isEmpty()) {
            Column(
                ...
                Text(
                    text = when {
                        content == null -> "Open Ember to load your tasks"
...
private fun toggleCompletedViewIntent(context: Context, appWidgetId: Int): Intent =
    Intent(context, TasksWidgetActionReceiver::class.java).apply {
        ...
        data = "ember-tasks://view/$appWidgetId".toUri()
...
private fun toggleTaskIntent(
    ...
    Intent(context, TasksWidgetActionReceiver::class.java).apply {
        ...
        data = "ember-tasks://task/$appWidgetId/$blockId".toUri()
        putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, appWidgetId)
