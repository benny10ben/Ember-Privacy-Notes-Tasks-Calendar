...
import com.ben.ember.presentation.widget.elevatedSurfaceColor
import com.ben.ember.presentation.widget.primaryTextColor
import com.ben.ember.presentation.widget.secondaryTextColor
import com.ben.ember.presentation.widget.separatorColor
                ...
                Column(
                    ...
                    Text(
                        text = if (content == null) {
                            "Open Ember to load today's tasks"
                        } else {
...
private fun toggleTaskIntent(
    ...
    Intent(context, TodayTasksWidgetActionReceiver::class.java).apply {
        ...
        data = "ember-today://task/$appWidgetId/$blockId".toUri()
...
private fun openDailyScreenIntent(context: Context): Intent {
    ...
    return Intent(context, MainActivity::class.java)
        .setData("ember://daily/$today".toUri())
